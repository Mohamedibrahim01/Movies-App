...
export default function TopRated() {
  const sortedMovies: Movie[] = getMovies().sort(
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-20 px-6 py-16 text-center">
          ...
          >
            Discover the highest-rated films according to IMDb ratings
          </motion.p>
          <motion.div
          ...
          >
            <span className="flex items-center gap-2">
              ...
              {sortedMovies.length} Top Rated Movies
            </span>
            <span className="flex items-center gap-2">
      ...
      <div className="px-6 py-12 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold text-white">Highest Rated Films</h2>
          <div className="text-gray-400">
            Showing top {Math.min(sortedMovies.length, 20)} movies
          </div>
        </motion.div>
            ...
            >
              <Link to={`/movie/${movie.id}`} state={{ movie }}>
                ...
                >
                  ...
                  {/* Movie Info */}
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-white mb-3 group-hover:text-yellow-400 transition-colors overflow-hidden">
                        ...
                        {[...Array(5)].map((_, i) => (
                          <span
                            ...
                            className={`text-sm ${
                              i <
                              Math.floor(
                                parseFloat(movie.imdbRating || "0") / 2
                              )
                                ? "text-yellow-400"
                                : "text-gray-600"
                            }`}
                  ...
                  {/* Hover Effect Border */}
                  <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-yellow-500/50 transition-colors duration-300"></div>
                </motion.li>
              </Link>
            </motion.div>
          ))}
        ...
        {sortedMovies.length > 20 && (
          ...
          >
            <motion.button
              className="group relative bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black font-semibold py-4 px-10 rounded-full shadow-xl transition-all duration-300 overflow-hidden"
